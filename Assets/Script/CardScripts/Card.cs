...
public class Card : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] TMP_Text cardBonusVisual;
    ...
    public void updateCardVisual()
    {
        ...
        if(BonusAttack>0){
            cardBonusVisual.gameObject.SetActive(true);
            cardBonusVisual.text = "+"+BonusAttack.ToString();
        }
        else{
            cardBonusVisual.gameObject.SetActive(false);
        }
        // cardImg=CardSprite;
    }
